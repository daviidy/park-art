...
<html lang="en" dir="ltr">
  ...
  <body class="main-content1">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav  mx-auto font-weight-bold">
              ...
              <div class="dropdown">
                <a class="dropdown-toggle text-decoration-none" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <main class="container-fluid">
      <div class="row">
        <!--progression-->
        <div class="col-3 d-none side-menu d-md-block bg-dark mt-5 pt-5">
            ...
            <div class="accordion" id="accordionExample">
              <div class="card border-0 rounded-0">
                <div class="card-header bg-dark" id="headingOne">
                  <h2 class="mb-0">
                    <button class="btn btn-link text-decoration-none d-flex justify-content-between align-items-center btn-block text-left bg-dark" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                      <div class="bg-dark">
              ...
              <div class="card border-0 rounded-0">
                <div class="card-header bg-dark" id="headingTwo">
                  <h2 class="mb-0">
                    <button class="bg-dark btn btn-link text-decoration-none d-flex justify-content-between align-items-center btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                      <div class="">
              ...
              <div class="card border-0 rounded-0">
                <div class="card-header bg-dark" id="headingThree">
                  <h2 class="mb-0">
                    <button class="bg-dark btn btn-link text-decoration-none d-flex justify-content-between align-items-center btn-block text-left collapsed bg-heard" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                      <div class="">
            ...
            <div class="col-md-12">
              <div class="card-deck">
                ...
                <div class="card shadow border-0 box-hover">
                  ...
                  <div class="box-img m-auto py-3 text-center">
                ...
                <div class="card shadow border-0 box-hover">
                  ...
                  <div class="box-img m-auto py-3 text-center">
                    <img style="width: 169px;" src="https://image.freepik.com/free-vector/illustration-people-with-money_53876-28543.jpg" alt="">
                  </div>
                  <div class="card-body">
