      ...
      <div class="col-md-10">
        <div class="card-body pt-2">
         ...
         .Auth::user()->id.'_'. $experience['title'].'/'.$experience['medias'][0]['name'] }}" alt="experience media"> </p>
          @endif
          <p class="card-text">
            <a href="" class="p-2 border rounded border-primary text-decoration-none update-experience" data-experience="{{ $experience['id'] }}">Modifier</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body p-0">
          <div class="card border-0" style="max-width: 540px;">
              <div class="col-md-12">
                <div class="card-body p-4" id="update-experience">
