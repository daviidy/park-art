    ...
    <div class="">
      ...
      <div class="">
        <div class="list-group text-center h1" id="Menu">
            ...
            <a href="{{ url('/nos-prestataires') }}" class="mr-2 py-2 text-decoration-none d-md-block d-flex align-items-center justify-content-around">
            ...
            <a href="{{ route('client.my-profile.edit', Auth::user()->id) }}" class="mr-2 py-2 text-decoration-none d-md-block d-flex align-items-center justify-content-around">
