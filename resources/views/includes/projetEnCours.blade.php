          ...
          <div class="col-md-3 pr-4">
            <div class="p-2 p-md-0 d-flex justify-content-around align-items-center">
              @if(Auth::user()->profile_image != "image_default.png")
                ...
                @endif
              <p class="card-text text-dark">Projet1 <span class="pl-1"> <a href="#"><i class="bi bi-pencil-square btn-delete"></i></a></span> </p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="p-2 p-md-0">
              <p class="card-text text-dark text-truncate pr-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo conse</p>
            </div>
          </div>
          <div class="col-md-2">
            <div class="p-2 p-md-0">
